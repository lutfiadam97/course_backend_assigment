...
<table>
  ...
  <tr>
      ...
      <td>nomor handphone</td><td>:</td><td><input type="text" name="no_hp" required></td>
  ...
  <tr>
      ...
      <td>
          ...
          $kota = $db->get("SELECT kota_id,nama_kota FROM tabel_kota WHERE status = 1");
...
<button><a href="http://localhost/game_database/">Back to Login</button>